...
def fbconnect():
    ...
    url1 = 'https://graph.facebook.com/v2.8/me?access_token=%s'\
    ...
    # Get user picture
    url1 = 'https://graph.facebook.com/v2.8/me/picture?access_token=%s'\
...
def gconnect():
    ...
    if stored_access_token is not None and gplus_id == stored_gplus_id:
        response = make_response(json.dumps('Current user alreadyconnected.'),
                                 200)
        response.headers['Content-Type'] = 'application/json'
        return response
